    ...
    return (
        <Formik initialValues={initialValues} validate={validateLoginForm} onSubmit={handleLoginForm}>
            ...
            <Form className={customStyles.form} action="">
                ...
                <Field className={customStyles.input} type="email" name="email" placeholder='Correo Electrónico'/>
                ...
                <a className='text-[#333] text-sm no-underline my-4 hover:underline hover:text-gray-900' href="#" onClick={handlePasswordReset}>Olvido su contraseña?</a>
