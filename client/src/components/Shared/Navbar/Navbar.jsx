    ...
    return (
        <nav className="flex items-center justify-between w-full h-[7vh] px-4 mx-auto text-white bg-bg_black">
            ...
            <ul className="hidden uppercase md:flex">
                <li className="p-4 transition-colors duration-500 hover:text-gray-400 hover:scale-105"><NavLink to="/">Home</NavLink></li>
                <li className="p-4 transition-colors duration-500 hover:text-gray-400"><a href="#about-us">About</a></li>
                ...
                <li className="p-4 transition-colors duration-500 hover:text-gray-400"><a href="#contact-us">Contact</a></li>
            </ul>
            ...
            <div className={!nav ? 'fixed left-0 top-0 w-[60%] border-r border-r-gray-900 h-full bg-bg_black ease-in-out duration-500 z-20' : 'top-0 h-full fixed left-[-100%] ease-in-out duration-1000 w-[60%]'}>
                ...
                <ul className='p-4 uppercase'>
                    ...
                    <li className="p-4 transition-colors duration-500 border-b border-gray-600 hover:text-gray-400"><a href="#about-us" onClick={closeNav}>About</a></li>
                    ...
                    <li className="p-4 transition-colors duration-500 hover:text-gray-400 "><a href="#contact-us" onClick={closeNav}>Contact</a></li>
                </ul>
            </div>
        </nav>
    )
