        ...
        <section className='relative'>
            ...
            <div className='relative z-10 w-full px-4 py-16 '>
                <div className='max-w-[1340px] mx-auto grid md:grid-cols-2'>
                    ...
                    {/* Contenedor de texto */}
                    <div className='flex flex-col justify-center p-4 text-justify bg-opacity-0 border border-white border-opacity-25 shadow-md rounded-2xl backdrop-blur-lg backdrop-filter'>
                        {/* Logo y Nombre */}
                        ...
                        {/* Texto */}
                        <h1 className='py-2 mb-5 text-2xl font-bold text-primary lg:text-4xl md:text-3xl'>Con mas de 5 años de trayectoria</h1>

                        {/* Vision y Misión */}
                        <div className="text-gray-900">
                            <p className="mb-2">
                                <strong className="block">Visión:</strong>
                            ...
                            <p>
                                <strong className="block">Misión:</strong>
