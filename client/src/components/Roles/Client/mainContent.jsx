            ...
            <section className='flex flex-grow gap-8 m-auto mt-4'>
                <div className='w-auto rounded-lg'>
                    ...
                    <div className='flex flex-grow w-auto gap-8 p-1 ml-6 mr-6 bg-gray-600 rounded-lg' >
                        <select className='p-2 mt-1 mb-1 ml-1 text-gray-800 bg-white border rounded-sm w-80 h-14'>
                            <option value=''>Seleccionar servicio</option>
                            {/* Agrega opciones de servicios aquí */}
                        </select>
                        <select className='mt-1 mb-1 text-gray-800 bg-white border rounded-sm w-80 h-14'>
                            <option value=''>Seleccionar fecha</option>
                            {/* Agrega opciones de fechas aquí */}
                        </select>
                        <select className='p-2 mt-1 mb-1 text-gray-800 bg-white border rounded-sm w-80 h-14'>
                            <option value=''>Seleccionar estilista</option>
                            {/* Agrega opciones de estilistas aquí */}
                        </select>
                        <select className='p-2 mt-1 text-gray-800 bg-white border rounded-sm mb- w-80 h-14'>
                            <option value=''>Seleccionar hora</option>
                            {/* Agrega opciones de horas aquí */}
                        </select>
                        
                        <button className='w-40 p-2 mt-1 mb-1 mr-1 text-gray-800 bg-white rounded-sm border-x-gray-950 h-14 hover:bg-blue-950 hover:text-white'>
                            Reservar cita
                        </button>
                    </div>
                </div>
