...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        if (token) {
            ...
            setUserData({
                ...
                phone: decodedToken.telefono,
                address: decodedToken.direccion
    ...
    return (
        <div className='h-full py-8 pl-4 pr-8 bg-white shadow-custom rounded-xl'>
            <div className="grid grid-cols-6 sm:grid-cols-10">
                ...
                {/* Main content */}
                <main className="col-span-8 overflow-hidden sm:border-l sm:px-8">
                    {/* Fisrt section */}
                    ...
                    <div className='py-4 mb-6 border-b border-gray-200'>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                            <p className="text-gray-600">Su correo electronico es: <strong>{}</strong></p>
                    ...
                    <div className='py-4 mb-6 border-b border-gray-200'>
                        ...
                        <button className="px-4 py-2 mt-4 text-white rounded-lg bg-primary">Guardar contraseña</button>
                    </div>

                    {/* Fourth section */}
                    <div className="mb-10">
                        <p className="py-2 text-xl font-semibold">Eliminar cuenta personal</p>
                        <p className="inline-flex items-center px-4 py-1 rounded-lg bg-rose-100 text-rose-600">
