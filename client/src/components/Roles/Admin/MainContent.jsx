...
function MainContent() {
  return (
    <main className='h-full col-span-5 bg-blue-500'>
        <header className='flex flex-col w-full gap-4 p-4 bg-green-400 md:flex-row'>
            <h1>Header</h1>
        </header>
        ...
        <section className='flex'>
            ...
            <div className='flex-1 w-1/3 p-4 bg-green-600'>
                <h3>Sub Content</h3>
